...
import 'package:himacheck/edit_teammember_page.dart';
...
class TeamManagementPage extends StatelessWidget {
  ...
  TeamManagementPage({required this.team});
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.of(context).push(MaterialPageRoute(
                builder: (context) => EditTeamMembersPage(team: team),
              ));
            },
          ),
        ],
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return ListTile(
                ...
                subtitle: Text('UserID: ${friend.userID}\nTeamID: ${friend.teamID}'),
              );
            },
          );
        },
